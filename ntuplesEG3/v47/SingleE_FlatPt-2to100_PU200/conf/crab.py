...
config.General.workArea = 'ntuplesEG3/v47/SingleE_FlatPt-2to100_PU200'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'ntuplesEG3/v47/SingleE_FlatPt-2to100_PU200/conf/input_cfg.py'
