...
config.General.workArea = 'ntuples2/v47/SinglePhoton_FlatPt-8to150_PU200'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'ntuples2/v47/SinglePhoton_FlatPt-8to150_PU200/conf/input_cfg.py'

config.Data.inputDBS = 'global'
config.Data.splitting = 'Automatic'
config.Data.unitsPerJob = 200
config.Data.totalUnits = 200000
config.Data.outLFNDirBase = '/store/user/jheikkil/TRG_retry/'
